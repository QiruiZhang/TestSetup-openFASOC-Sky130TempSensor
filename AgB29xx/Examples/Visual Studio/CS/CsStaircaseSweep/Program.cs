...
namespace AgB29xx_CS_StaircaseSweep
{
    /// <summary>
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("  CS_StaircaseSweep");
            Console.WriteLine();
            AgB29xx driver = null;
            ...
            try
            {
                ...
                for (int i = 1; i <= iNumberOfChannels; i++)
                {
                    ...
                    driver.Transients.get_Item(driver.Transients.get_Name(i)).Voltage.Mode = Agilent.AgB29xx.Interop.AgB29xxTransientCurrentVoltageModeEnum.AgB29xxTransientCurrentVoltageModeSweep;
                    driver.Transients.get_Item(driver.Transients.get_Name(i)).Voltage.Start = -5.0;
                    driver.Transients.get_Item(driver.Transients.get_Name(i)).Voltage.Stop = +5.0;
                    driver.Transients.get_Item(driver.Transients.get_Name(i)).Voltage.SweepPoints = 11;
                ...
                Console.WriteLine("Staircase sweep data:");
