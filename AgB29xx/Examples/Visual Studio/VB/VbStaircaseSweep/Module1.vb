...
Module Module1
    ...
    Sub Main()
        ...
        Console.WriteLine("  VB_StaircaseSweep")
        Console.WriteLine()
        ...
        Try
            ...
            For i = 1 To iNumberOfChannels
                ...
                driver.Transients.Item(driver.Transients.Name(i)).Voltage.Mode = Agilent.AgB29xx.Interop.AgB29xxTransientCurrentVoltageModeEnum.AgB29xxTransientCurrentVoltageModeSweep
                driver.Transients.Item(driver.Transients.Name(i)).Voltage.Start = -5.0
                driver.Transients.Item(driver.Transients.Name(i)).Voltage.Stop = +5.0
                driver.Transients.Item(driver.Transients.Name(i)).Voltage.SweepPoints = 11
