...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	for (i = 1; i <= iNumberOfChannels; i++)
    {
		...
		AgB29xx_SetAttributeViInt32(session,TransientName,AGB29XX_ATTR_TRANSIENT_VOLTAGE_MODE,AGB29XX_VAL_TRANSIENT_CURRENT_VOLTAGE_MODE_SWEEP);
		AgB29xx_SetAttributeViReal64(session , TransientName, AGB29XX_ATTR_TRANSIENT_VOLTAGE_START , -5.0);
        AgB29xx_SetAttributeViReal64(session , TransientName, AGB29XX_ATTR_TRANSIENT_VOLTAGE_STOP , +5.0);
		AgB29xx_SetAttributeViInt32(session,TransientName,AGB29XX_ATTR_TRANSIENT_VOLTAGE_SWEEP_POINTS, 11);    
